...
function setup() {
    ...
    [
        [[433, 301], [406, 283], [371, 287], [348, 318], [342, 361],
         [354, 399], [388, 426], [413, 448], [435, 474], [427, 507], // S
         [400, 526], [362, 526], [329, 506]],
        
        [[476, 409], [475, 446], [477, 486], [477, 525], [478, 562],
         [480, 595], [510, 406], [547, 419], [553, 455], [526, 486]], // P
        
        [[596, 412], [595, 450], [598, 489], [597, 526], [631, 529],
         [672, 532], [631, 410], [674, 409], [633, 470]],                // E

        [[719, 515], [718, 485], [718, 454], [733, 425], [762, 416],    // N
         [794, 426], [810, 457], [815, 489], [816, 515]],
        
        [[923, 438], [896, 422], [862, 428], [851, 463], [858, 500],    // C
        [882, 525], [926, 517]],
         
        [[972, 405], [972, 441], [974, 475], [974, 514], [1008, 518],
        [1042, 521], [1013, 399], [1047, 398], [1006, 457]],            // E

        [[1096, 405], [1094, 442], [1096, 473],
        [1094, 510], [1094, 544], [1124, 429], [1151, 414], [1182, 413], [1210, 431]]   // R
    ].forEach(
        (letterArr, i) => letterArr.forEach(
            (pos) => nameBubbles.push(new NameBubble(pos[0] + (25 * i) - 50, pos[1] - 650))
        )
    )
